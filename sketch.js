...
function draw() {
  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      cashG.destroyEach();
      treasureCollection=treasureCollection+10000;
    }
    else if (diamondsG.isTouching(boy)) {
      diamondsG.destroyEach();
      treasureCollection=treasureCollection+10000000;
      ...
      treasureCollection= treasureCollection + 150000000;
     ...
     // boy.addAnimation(endImg);
       // boy.addAnimation("SahilRunning","FimDeJogo.png");
